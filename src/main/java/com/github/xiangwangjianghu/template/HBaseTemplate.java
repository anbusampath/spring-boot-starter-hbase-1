package com.github.xiangwangjianghu.template;

import com.github.xiangwangjianghu.api.HBaseOperations;
import com.github.xiangwangjianghu.api.MutatorCallback;
import com.github.xiangwangjianghu.api.RowMapper;
import com.github.xiangwangjianghu.api.TableCallback;
import com.github.xiangwangjianghu.exception.HBaseSystemException;
 ...
 * User: xiangwangjianghu.
 * Date: 2019-05-17.
 * Time: 10:43.
 * To change this template use File Or Preferences | Settings | Editor | File and Code Templates.
 * File Description: Central class for accessing the HBase API. Simplifies the use of HBase and helps to avoid common errors. It executes core HBase workflow, leaving application code to invoke actions and extract results.
 */
        ...
        try {
            ...
            if (null != mutator) {
                try {
                    ...
                    logger.error("HBase Mutator resource release failed");
                }
            }
        }
    }
            ...
            synchronized (this) {
                if (null == this.connection) {
                    try {
                        ...
                        logger.error("HBase Connection resource release failed");
                    }
                }
            }
        }
